...
class StreamChatService {
  ...
  Future<QueryReactionsResponse> getReactions(String messageId, {PaginationParams? pagination}) async {
    try {
  ...
  Future<SendMessageResponse> sendThreadedReply(Channel channel, Message parentMessage, String text) async {
    try {
